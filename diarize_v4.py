...
audio_waveform = torch.tensor(audio_waveform)  # Ensure audio_waveform is a 2D tensor
...
logger.debug(f"Number of Segments Processed: {len(emissions)}")
...
torchaudio.save(
    ...
    audio_waveform.squeeze(0).float(),  # Remove batch dimension
    16000,
    channels_first=True,
)
